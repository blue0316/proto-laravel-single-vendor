$( document ).ready( function () {
    ...
    */
    ...
    $( '.modal-confirm' ).click( function () {
        $.ajax( {
            url: baseUrl + '/admin/posts/comments/bulk',
            type: 'DELETE',
            data: {
                data: commentsArray,
            },
    ...
    $( '#post-replies-list-form' ).on( 'change', '.approved-toggle', function () {
        var currentRow = $( this ).closest( 'tr' );
        var commentId = currentRow.find( "input[type='checkbox']" ).data( 'id' );
        var url = baseUrl + '/admin/posts/comments/' + commentId;
    ...
    $( '.submit-reply' ).click( function () {
        ...
        var post_id = $( '.reply-to' ).find( '.response-to' ).data( 'post-id' );

        $.ajax( {
            url: baseUrl + '/admin/posts/comments',
            type: 'POST',
            data: {
