...
class AttributeController extends Controller {
	...
	public function index() {
		...
		return view( 'admin.products.attributes.list', array( 'attributes' => $attributes ) );
	}
	...
	public function edit( $id ) {
		...
		return view( 'admin.products.attributes.edit', array( 'attribute' => $attribute ) );
	}
