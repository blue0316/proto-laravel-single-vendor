...
class PostCommentController extends Controller {
	...
	public function index( Request $request ) {
		...
		return view( 'admin.comments.post.list', array( 'comments' => $comments ) );
	}
	...
	public function edit( $id ) {
		...
		return view( 'admin.comments.post.edit', array( 'comment' => $comment ) );
	}
	...
	public static function getCommentTreeForVue( $post_id ) {
		...
		$stack                = collect( array( $approved_comment_ids ) );
		$tree                 = collect( array() );
