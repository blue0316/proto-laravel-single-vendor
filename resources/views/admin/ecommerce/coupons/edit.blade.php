                                ...
                                <div class="tab-content" id="tabContent">
                                    ...
                                    <div class="tab-pane fade" id="usage-restriction" role="tabpanel" aria-labelledby="usage-restriction-tab">
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-lg-7 col-xl-6">
                                                <input type="text" min="0" class="form-control form-control-modern" name="minimum_spend" value="{{ $coupon->minimum_spend }}" placeholder="e.g 10.00" />
                                            </div>
                                        </div>
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-lg-7 col-xl-6">
                                                <input type="text" min="0" class="form-control form-control-modern" name="maximum_spend" value="{{ $coupon->maximum_spend }}" placeholder="e.g 1000.00" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
