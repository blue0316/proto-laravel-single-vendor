...
@section('page-content')
    @include('admin.common.breadcrumb', ['current_page' => 'Edit Home Page', 'paths' => ['home' => '/dashboard']])
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-2-5 col-xl-1-5">
                                ...
                                <h2 class="card-big-info-title">Home Slider</h2>
                                <p class="card-big-info-desc">Add here home slider images and their description.</p>
                            </div>
