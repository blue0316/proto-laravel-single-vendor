                        ...
                        <div class="row">
                            ...
                            <section class="col-sm-9">
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <input type="text" class="form-control col-md-9" name="db_name" required value="{{ old('db_name', 'dthemes_porto_laravel') }}" />
                                </div>
                                <div class="form-group row align-items-center">
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <input type="password" class="form-control col-md-9" name="db_password" value="{{ old('db_password') }}" />
                                </div>
                                <br />
