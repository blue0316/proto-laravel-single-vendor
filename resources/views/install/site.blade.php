                    ...
                    <div class="tab-pane fade in show active" id="site">
                        <div class="row">
                            ...
                            <section class="col-sm-9">
                                ...
                                <p>It is time to configure site url. It is very important for shared web hosting. The standard site url is <strong>laravel/porto/{{ env('DEMO') }}</strong> because the project is installed in <strong>laravel/porto/{{ env('DEMO') }}</strong> directory.<br />
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <input type="text" class="form-control col-md-9" name="app-url" value="laravel/porto/{{ env('DEMO') }}" />
                                </div>
