                        ...
                        <div class="row">
                            ...
                            <section class="col-sm-9">
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <input type="password" class="form-control col-md-9" name="password" value="dthemes_porto_laravel" required />
                                </div>
                                <div class="form-group row align-items-center">
                                    <label class="col-md-3 mb-0">Password Confirm</label>
                                    <input type="password" class="form-control col-md-9" name="password_confirmation" value="dthemes_porto_laravel" required />
                                </div>
                                <div class="form-group row align-items-center">
